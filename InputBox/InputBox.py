...
def main():
	...
	gameDisplay.blit(pygame.image.load('Galaxy.jpg').convert(), (0, 0))
	pygame.display.update()
	rect = pygame.Rect(200, 200, 200, 40)
	bk_image = pygame.image.load('WoodFrame.jpg').convert()
	print(InputBox(rect, text = '1234567', bk_image = bk_image, text_color = (0, 255, 255)))
	pygame.quit()
